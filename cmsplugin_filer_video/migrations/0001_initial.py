    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', filer.fields.image.FilerImageField(related_name='filer_video_image', on_delete=django.db.models.deletion.SET_NULL, default=None, to='filer.Image', blank=True, help_text='preview image file', null=True, verbose_name='image')),
                ('movie', filer.fields.file.FilerFileField(on_delete=django.db.models.deletion.SET_NULL, default=None, to='filer.File', blank=True, help_text='use .flv file or h264 encoded video file', null=True, verbose_name='movie file')),
            ],
            options={
                'db_table': 'cmsplugin_filervideo',
            },
            bases=('cms.cmsplugin',),
        ),
    ]
