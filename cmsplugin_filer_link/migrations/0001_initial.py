    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mailto', models.EmailField(help_text='An email address has priority over both pages and urls', max_length=75, null=True, verbose_name='email address', blank=True)),
                ...
                ('file', filer.fields.file.FilerFileField(on_delete=django.db.models.deletion.SET_NULL, default=None, blank=True, to='filer.File', null=True)),
